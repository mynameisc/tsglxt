		...
		<div class="container-fluid content">	
			<div class="row">
				...
				<div class="main ">
					...
					<!-- End Page Header -->
					<h4>${error_info}</h4>
				<form action="/tsglxt/AdminbookAdd" method="post">
					<div class="form-group">
						<label for="nf-email">id_rfid</label>
						<input type="text" name="id_rfid" class="form-control" value="${bookrfid }" readOnly="true">
					</div>
					<div class="form-group">
					...
					<div>
						...
						<input type="text"  name="bk_amount" class="form-control" placeholder="类别">
					</div>
					<div>
